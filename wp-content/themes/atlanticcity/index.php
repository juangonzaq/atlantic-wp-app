...
<div class="bg-dark flex flex-col pb-24 w-full margin-top-header">
    <?php 
        if (property_exists($category, "term_id")){
            ...
            if ($orderitems == "arriba") {
                ...
                <div class="w-full md:h-subtitle bg-dark-bold flex items-center px-0 md:px-8 justify-center md:justify-start">
                    <div class="flex flex-col md:flex-row w-full h-full items-center">
                        <h1 class="text-2xl font-semibold text-white my-auto py-5 md:py-0 px-8 md:px-0">
                            <?php echo $nameCategory; ?>
                        </h1>
                        <!-- SEPARATION -->
            ...
            ?>
            <div class="flex flex-col md:flex-row gap-x-8 h-full <?php if ($orderitems == "arriba") { echo "pl-5"; }?>">
                <?php 
                    if ($orderitems == "izquierdo") {
                        ?>
                                ...
                                <div class="w-full">
                                    <article class="w-full notice">
                                        <a href="<?php echo get_permalink($myid); ?>" class="flex w-full flex-col items-start justify-between relative overflow-hidden max-h-96 rounded-lg">
                                            <img src="<?php echo get_the_post_thumbnail_url($myid); ?>" alt="" class="rounded-lg object-cover object-center w-full h-full notice-image">
                                            ...
                                            <article class="w-full notice">
                                                <a href="<?php echo get_permalink($myid); ?>" class="flex w-full flex relative overflow-hidden bg-gray rounded-lg">
                                                    <div class="w-2/5 relative">
                                                        <img src="<?php echo get_the_post_thumbnail_url($myid); ?>" alt="" class="rounded-tl-lg rounded-bl-lg object-cover object-center w-full h-full notice-image">
                                                    </div>
                                                    <div class="w-3/5">
                                        ...
                                        <article class="w-full notice">
                                            <a href="<?php echo get_permalink($myid); ?>" class="flex bg-gray w-full flex-col items-start justify-between rounded-lg">
                                                <div class="w-full relative overflow-hidden h-56">
                                                    <img src="<?php echo get_the_post_thumbnail_url($myid); ?>" alt="" class="rounded-tl-lg rounded-tr-lg object-cover object-center w-full h-full notice-image">
                                                </div>
                    ...
                    <?php 
                        ...
                        <?php if ($la['type'] == "clasificacion") { ?>   
                            <div class="w-full bg-gray rounded-xl">
                                <div class="flex w-full border-solid border-b border-gray-light py-3 px-4 flex items-center justify-center min-h-16">
                                    <h2 class="text-xl font-medium text-white">CLASIFICACIÓN</h2>
                                </div>
                                <div class="w-full flex items-center justify-between">
                                    <div class="w-1/2 py-6">
                                        <span class="flex items-center justify-center px-6">
                                            <span class="h-5 w-5 rounded-full bg-green-es mr-4"></span>
                                            <span class="text-white font-normal text-base">Champions League</span>
                                        </span>
                                    </div>
                                    <div class="w-1/2 py-6">
                                        <span class="flex items-center justify-center px-6">
                                            <span class="h-5 w-5 rounded-full bg-green-dark-es mr-4"></span>
                                            <span class="text-white font-normal text-base">Europa League</span>
                                        </span>
                                    </div>
                                </div>
                                <div class="w-full">
                                    <table class="w-full">
                                        <thead class="border-solid border-b border-t border-gray-light bg-table-header">
                                            <tr>
                                                <th class="text-white font-normal text-base py-3 px-4">Club</th>
                                                <th class="text-white font-normal text-base py-3 px-4">GF</th>
                                                <th class="text-white font-normal text-base py-3 px-4">P</th>
                                                <th class="text-white font-normal text-base py-3 px-4">PTS</th>
                                            </tr>
                                        </thead>
                                        <tbody class="bg-table-body">
                                            <tr>
                                                <td class="py-3 px-4">
                                                    <span class="flex items-center">
                                                        <!--<img class="w-8 h-8 mr-4" src="assets/img/icons/sub-2.svg" alt="">-->
                                                        <span class="text-white font-light text-base text-white">Inter de Milan</span>
                                                    </span>
                                                </td>
                                                <td class="py-3 px-4 text-center">
                                                    <span class="text-white font-light text-base text-white">20</span>
                                                </td>
                                                <td class="py-3 px-4 text-center">
                                                    <span class="text-white font-light text-base text-white">24</span>
                                                </td>
                                                <td class="py-3 px-4 text-center">
                                                    <span class="text-white font-light text-base text-white">36</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="py-3 px-4">
                                                    <span class="flex items-center">
                                                        <!--<img class="w-8 h-8 mr-4" src="assets/img/icons/sub-2.svg" alt="">-->
                                                        <span class="text-white font-light text-base text-white">Milan</span>
                                                    </span>
                                                </td>
                                                <td class="py-3 px-4 text-center">
                                                    <span class="text-white font-light text-base text-white">14</span>
                                                </td>
                                                <td class="py-3 px-4 text-center">
                                                    <span class="text-white font-light text-base text-white">24</span>
                                                </td>
                                                <td class="py-3 px-4 text-center">
                                                    <span class="text-white font-light text-base text-white">32</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="py-3 px-4">
                                                    <span class="flex items-center">
                                                        <!--<img class="w-8 h-8 mr-4" src="assets/img/icons/sub-2.svg" alt="">-->
                                                        <span class="text-white font-light text-base text-white">Juventus</span>
                                                    </span>
                                                </td>
                                                <td class="py-3 px-4 text-center">
                                                    <span class="text-white font-light text-base text-white">10</span>
                                                </td>
                                                <td class="py-3 px-4 text-center">
                                                    <span class="text-white font-light text-base text-white">24</span>
                                                </td>
                                                <td class="py-3 px-4 text-center">
                                                    <span class="text-white font-light text-base text-white">28</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="py-3 px-4">
                                                    <span class="flex items-center">
                                                        <!--<img class="w-8 h-8 mr-4" src="assets/img/icons/sub-2.svg" alt="">-->
                                                        <span class="text-white font-light text-base text-white">Napoles</span>
                                                    </span>
                                                </td>
                                                <td class="py-3 px-4 text-center">
                                                    <span class="text-white font-light text-base text-white">10</span>
                                                ...
                                                <td class="py-3 px-4 text-center">
                                                    <span class="text-white font-light text-base text-white">18</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="py-3 px-4">
                                                    <span class="flex items-center">
                                                        <!--<img class="w-8 h-8 mr-4" src="assets/img/icons/sub-2.svg" alt="">-->
                                                        <span class="text-white font-light text-base text-white">Atalanta</span>
                                                    </span>
                                                </td>
                                                <td class="py-3 px-4 text-center">
                                                    <span class="text-white font-light text-base text-white">8</span>
                                                </td>
                                                <td class="py-3 px-4 text-center">
                                                    <span class="text-white font-light text-base text-white">24</span>
                                                </td>
                                            ...
                                            <tr>
                                                <td class="py-3 px-4">
                                                    <span class="flex items-center">
                                                        <!--<img class="w-8 h-8 mr-4" src="assets/img/icons/sub-2.svg" alt="">-->
                                                        <span class="text-white font-light text-base text-white">Fiorentina</span>
                                                    </span>
                                                </td>
                                                <td class="py-3 px-4 text-center">
                                                    <span class="text-white font-light text-base text-white">20</span>
                                                ...
                                                <td class="py-3 px-4 text-center">
                                                    <span class="text-white font-light text-base text-white">13</span>
                                                </td>
                                            </tr>
                                        </tbody>
                                        <tfoot>
                                            <tr>
                                                <td class="py-4 px-4" colspan="4">
                                                    <div class="w-full flex items-center justify-center">
                                                        <a href="" class="text-primary text-base font-normal hover:underline cursor-pointer">Ver más</a>
                                                    </div>
                                                </td>
                                            </tr>
                                        </tfoot>
